...
class CrashHandler
{
	...
	private static function onUncaughtError(e:UncaughtErrorEvent):Void
	{
		try
		{
			...
			try
			{
				...
				File.saveContent(path, '$errorMessage\n\nCrash happened on Star Engine v${funkin.ui.menu.MainMenuState.psychEngineVersion}!');
			}
			catch (e)
		...
		if (ClientPrefs.peOGCrash)
		{
			...
			CoolUtil.showPopUp(errorMessage,
				"Error! Star Engine v"
				+ funkin.ui.menu.MainMenuState.psychEngineVersion
				+ " ("
	...
	{
		var fullContents = 'Generated by: ${funkin.utils.Constants.GENERATED_BY}\n';
		...
		fullContents += '=====================\n';
		fullContents += '\n';
		fullContents += Memory.buildGCInfo();
		return fullContents;
	}
}
...
class Crash extends FlxState
{
	override public function create()
	{
		...
		var ohNo:FlxText = new FlxText(0, 0, 1280,
			'Star Engine v${funkin.ui.menu.MainMenuState.psychEngineVersion} has crashed!\n\n'
			+ Main.__superCoolErrorMessagesArray[FlxG.random.int(0, Main.__superCoolErrorMessagesArray.length)]
			+ '\n\n'
			+ stripClub
			...
			if (FlxG.keys.justPressed.ENTER)
			{
				...
				new FlxTimer().start(1, e ->
				{
					...
					if (countDown == 0)
					{
						...
						FlxG.switchState(new funkin.ui.menu.MainMenuState());
					}
				}, 10);
			}
