...
import funkin.shaders.VFDOverlay;
			...
			case ParsingCharacters:
				...
				else if (Constants.PRELOADER_MIN_STAGE_TIME > 0)
				{
					...
					else
					{
						...
						else return elapsedParsingCharacters / Constants.PRELOADER_MIN_STAGE_TIME;
					}
				}
				else
				{
