...
import funkin.ui.editors.MasterEditorMenu;
import funkin.utils.CoolUtil;
import funkin.utils.MathUtil;
import funkin.utils.MusicBeatState;
import funkin.utils.SUtil;
...
class MainMenuState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.sound.music.volume < 0.8)
		{
			...
			if (funkin.ui.freeplay.FreeplayState.vocals != null)
				funkin.ui.freeplay.FreeplayState.vocals.volume += 0.5 * elapsed;
		}
		...
		var lerpVal:Float = funkin.utils.MathUtil.mathBound(elapsed * 7.5, 0, 1);
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									...
									case 'mods':
										MusicBeatState.switchState(new funkin.ui.ModsMenuState());
									case 'awards':
										MusicBeatState.switchState(new funkin.ui.achievements.AchievementsMenuState());
									case 'credits':
