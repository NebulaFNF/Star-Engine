...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		// banger eye leave me alone please
		#if TITLE_SCREEN_EASTER_EGG
		...
		#else
		if (FlxG.save.data.flashing == null && !funkin.ui.flashing.FlashingState.leftState)
		{
			FlxTransitionableState.skipNextTransIn = true;
			FlxTransitionableState.skipNextTransOut = true;
			MusicBeatState.switchState(new funkin.ui.flashing.FlashingState());
		}
		else
		{
			#if desktop
	...
	override function beatHit()
	{
		...
		if (cheatActive && Conductor.bpm % 2 == 0)
			swagShader.update(0.125);
