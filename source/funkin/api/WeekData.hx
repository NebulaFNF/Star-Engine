...
class WeekData {
	...
	private static function addWeek(weekToCheck:String, path:String, directory:String, i:Int, originalLength:Int)
	{
		if(!weeksLoaded.exists(weekToCheck))
		{
			...
			if(week != null)
			{
				...
				if((funkin.play.PlayState.isStoryMode && !weekFile.hideStoryMode) || (!funkin.play.PlayState.isStoryMode && !weekFile.hideFreeplay))
				{
	...
	public static function getWeekFileName():String {
		return weeksList[funkin.play.PlayState.storyWeek];
	}

	//Used on LoadingState, nothing really too relevant
	public static function getCurrentWeek():WeekData {
		return weeksLoaded.get(weeksList[funkin.play.PlayState.storyWeek]);
	}
