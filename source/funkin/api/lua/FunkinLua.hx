...
class FunkinLua {
	...
	public var ffmpegDuration:Float = 1;
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "loadSong", function(?name:String = null, ?difficultyNum:Int = -1) {
			...
			var poop = funkin.score.Highscore.formatSong(name, difficultyNum);
		...
		Lua_helper.add_callback(lua, "noteTweenX", function(tag:String, note:Int, value:Dynamic, duration:Float, ease:String) {
			cancelTween(tag);
			if(note < 0) note = 0;
			var testicle:StrumlineNote = PlayState.instance.strumLineNotes.members[note % PlayState.instance.strumLineNotes.length];
		...
		Lua_helper.add_callback(lua, "restartSong", function(?skipTransition:Bool = false) {
			PlayState.instance.persistentUpdate = false;
			funkin.ui.play.pause.PauseSubState.restartSong(skipTransition);
			return true;
		});
		Lua_helper.add_callback(lua, "exitSong", function(?skipTransition:Bool = false) {
			...
			funkin.ui.transition.CustomFadeTransition.nextCamera = PlayState.instance.camOther;
		...
		Lua_helper.add_callback(lua, "addChromaticAbberationEffect", function(camera:String,chromeOffset:Float = 0.1)
		{
