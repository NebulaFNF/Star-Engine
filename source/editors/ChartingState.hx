...
class ChartingState extends FlxState
{
	...
	var eventStuff:Array<Dynamic> = [
		...
		['Set Property', "Value 1: Variable name\nValue 2: New value"] // ['Crash the Computer', "put the event in a certain place and boom"]
	];
	...
	**/
	...
	function addNoteStackingUI():Void
	{
		...
		var dupeNotesButton:FlxButton = new FlxButton(10, stepperDuplicateAmount.y + 20, "Duplicate Notes", function()
		{
			...
			_song.notes[curSec].sectionNotes.length <= 30000 ? updateGrid() : changeSection(curSec +
