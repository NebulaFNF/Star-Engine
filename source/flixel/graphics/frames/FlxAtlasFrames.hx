...
class FlxAtlasFrames extends FlxFramesCollection
{
    ...
    override function destroy()
	{
		while (usedGraphics.length > 0)
			usedGraphics.shift().incrementUseCount();
	 ...
	 * @since 5.3.0
	 */
	public function addAtlasEx(collection:FlxAtlasFrames, overwriteHash = false)
	{
	...
	public function concat(collection:FlxAtlasFrames, overwriteHash = false)
	{
		...
		newCollection.addAtlasEx(this);
		newCollection.addAtlasEx(this, overwriteHash);
		return this;
	}
}
